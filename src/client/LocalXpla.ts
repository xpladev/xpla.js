...
export class LocalXpla extends LCDClient {
  public wallets: {
    validator: Wallet;
    test1: Wallet;
    test2: Wallet;
  ...
  constructor(isClassic?: boolean) {
    ...
    this.wallets = {
      validator: this.wallet(
        new MnemonicKey({ mnemonic: LOCALXPLA_MNEMONICS.validator })
      ),
      test1: this.wallet(
        new MnemonicKey({ mnemonic: LOCALXPLA_MNEMONICS.test1 })
      ),
      test2: this.wallet(
        new MnemonicKey({ mnemonic: LOCALXPLA_MNEMONICS.test2 })
      ),
      test3: this.wallet(
        new MnemonicKey({ mnemonic: LOCALXPLA_MNEMONICS.test3 })
      ),
      test4: this.wallet(
        new MnemonicKey({ mnemonic: LOCALXPLA_MNEMONICS.test4 })
      ),
      test5: this.wallet(
        new MnemonicKey({ mnemonic: LOCALXPLA_MNEMONICS.test5 })
      ),
      test6: this.wallet(
        new MnemonicKey({ mnemonic: LOCALXPLA_MNEMONICS.test6 })
      ),
      test7: this.wallet(
        new MnemonicKey({ mnemonic: LOCALXPLA_MNEMONICS.test7 })
      ),
      test8: this.wallet(
        new MnemonicKey({ mnemonic: LOCALXPLA_MNEMONICS.test8 })
      ),
      test9: this.wallet(
        new MnemonicKey({ mnemonic: LOCALXPLA_MNEMONICS.test9 })
      ),
      test10: this.wallet(
        new MnemonicKey({ mnemonic: LOCALXPLA_MNEMONICS.test10 })
      ),
    };
  }
}
