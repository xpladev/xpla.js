...
> {
  ...
  public static fromData(
    ...
    return new MsgIbcSoftwareUpgradeV1(
      ...
      upgraded_client_state ? Any.fromJSON(upgraded_client_state) : undefined,
      signer,
    );
  }
  ...
  public toData(_?: boolean): MsgIbcSoftwareUpgradeV1.Data {
    ...
    return {
      ...
      upgraded_client_state: upgraded_client_state ? Any.toJSON(upgraded_client_state) : undefined,
      signer,
    };
  }
