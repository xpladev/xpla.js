...
export class Header extends JSONSerializable<any, Header.Data, Header.Proto> {
  ...
  public static fromProto(proto: Header.Proto): Header {
    ...
    return new Header(
      ...
      Convert.toBase64(lastCommitHash),
      Convert.toBase64(dataHash),
      Convert.toBase64(validatorsHash),
      Convert.toBase64(nextValidatorsHash),
      Convert.toBase64(consensusHash),
      Convert.toBase64(appHash),
      Convert.toBase64(lastResultsHash),
      Convert.toBase64(evidenceHash),
      Convert.toUTF8(proposerAddress),
    );
  }
  ...
  public toProto(): Header.Proto {
    ...
    return Header_pb.fromPartial({
      ...
      lastCommitHash: Convert.fromBase64(lastCommitHash),
      dataHash: Convert.fromBase64(dataHash),
      validatorsHash: Convert.fromBase64(validatorsHash),
      nextValidatorsHash: Convert.fromBase64(nextValidatorsHash),
      consensusHash: Convert.fromBase64(consensusHash),
      appHash: Convert.fromBase64(appHash),
      lastResultsHash: Convert.fromBase64(lastResultsHash),
      evidenceHash: Convert.fromBase64(evidenceHash),
      proposerAddress: Convert.fromUTF8(proposerAddress),
    });
  }
}
...
> {
  ...
  public static fromProto(proto: CommitSig.Proto): CommitSig {
    ...
    return new CommitSig(
      blockIdFlag,
      Convert.toBase64(validatorAddress),
      timestamp,
      Convert.toBase64(signature),
    );
  }
  ...
  public toProto(): CommitSig.Proto {
    ...
    return CommitSig_pb.fromPartial({
      ...
      validatorAddress: validatorAddress
        ? Convert.fromBase64(validatorAddress)
        : undefined,
      timestamp,
      signature: signature
        ? Convert.fromBase64(signature)
        : undefined,
    });
  }
}
...
> {
  ...
  public toProto(): Validator.Proto {
    ...
    return Validator_pb.fromPartial({
      address: Convert.fromBase64(address),
